...
alert(`Siz yozgan ${string} sozi string typega tegishli\nSiz yozgan ${number} sozi number typega tegishli\nSiz yozgan ${boolean} sozi boolean typega tegishli`)
console.log('String: ' + first);
console.log('Number: ' + second);
console.log('Boolen: ' + third);
